...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_empty_2eproto = {
  false, false, descriptor_table_protodef_empty_2eproto, "empty.proto", 167,
...
static bool dynamic_init_dummy_empty_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_empty_2eproto)), true);
namespace google {
namespace protobuf {
