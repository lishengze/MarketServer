...
void HubLog::record_input_info(const string& channel, const SDepthData& depth)
{
    try
    {
...
void HubLog::record_input_info(const string& channel, const Trade& trade)
{
    try
    {
        std::stringstream stream_obj;
...
void HubLog::record_input_info(const string& channel, const vector<KlineData>& klines)
{
    try
    {
        {
...
void HubLog::record_output_info(const string& info, const SDepthData& depth)
{
    try
    {
...
void HubLog::record_output_info(const string& info, const Trade& trade)
{
    try
    {
        record_output_info(info);
...
void HubLog::record_output_info(const string& info, const vector<KlineData>& klines)
{
    try
    {
...
void HubLog::record_output_info(const string& info, const std::vector<KlineDataPtr>& klines)
{
    try
    {
        {
...
void HubLog::record_client_info(const string& client_id, const string& info)
{
    try
    {
        {
...
void HubLog::log_client_request(const string& info)
{
    try
    {
...
void HubLog::log_debug(const string& info)
{
    try
    {
