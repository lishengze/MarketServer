...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_gogo_2eproto = {
  false, false, descriptor_table_protodef_gogo_2eproto, "gogo.proto", 4418,
...
static bool dynamic_init_dummy_gogo_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_gogo_2eproto)), true);
namespace gogoproto {
